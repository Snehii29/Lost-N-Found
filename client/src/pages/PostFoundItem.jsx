...
function PostFoundItem() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    console.log('Found Item:', formData, image)
    setSubmitted(true)
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Help someone get their item back!
          </p>
        </div>
        ...
        <div style={{
          ...
          <div
            ...
            style={{
              ...
              height: '180px',
              borderRadius: '16px',
              border: `2px dashed ${imagePreview ? theme.accent : '#00cc6666'}`,
              background: imagePreview ? 'transparent' : '#00cc6611',
              display: 'flex',
              alignItems: 'center',
            ...
            onMouseLeave={e => e.currentTarget.style.border = `2px dashed ${imagePreview ? theme.accent : '#00cc6666'}`}
          >
            {imagePreview ? (
              <img
                src={imagePreview}
          ...
          <button
            ...
            style={{
              ...
              background: submitted
                ? 'linear-gradient(135deg, #FFC700, #e6b300)'
                : 'linear-gradient(135deg, #00cc66, #00e676)',
              color: submitted ? '#1a1a1a' : '#ffffff',
              fontFamily: 'Poppins, sans-serif',
              fontWeight: '700',
              cursor: 'pointer',
          ...
          >
            {submitted ? 'Posted Successfully!' : 'Post Found Item'}
          </button>
        </div>
      </div>
    </div>
